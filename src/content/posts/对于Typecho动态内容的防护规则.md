...
![](../assets/images/对于Typecho动态内容的防护规则.png)
...
- **作用**：确保搜索引擎正常收录内容，且不会被Cloudflare WAF拦截
...
- **作用**：防止后台被爆破或恶意扫描，且每次进入后台都要人机验证一下
...
> 警告！ 阈值需结合实际访问情况进行调整，你可以在游览器的控制台→网络处获取详细信息
...
在完成以上配置后，Typecho 博客的动态内容将具备强大防护能力，抵御基本的CC攻击无忧。如有疑问或更佳建议，欢迎在评论区留言交流！
