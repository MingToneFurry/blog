...
本文主要讲解如何通过**自定义缓存规则**解决第二个问题。关于 IP 优选方法，请参考：[二叉树树的博客](https://blog.acofork.com/posts/cf-fastip/)。
...
![](../assets/images/typecho在cloudflare的缓存规则.png)
- 点击 **创建规则**。
![](../assets/images/typecho在cloudflare的缓存规则-1.png)
- 输入规则名称，选择 **所有传入请求**。
...
设置完大概长这样：
![](../assets/images/typecho在cloudflare的缓存规则-4.png)
