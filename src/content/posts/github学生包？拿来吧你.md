...
### 开始验证
  ...
  4. 前往 Location Guard插件的设置页面，配置好学生证上的地址![](../assets/images/Github学生包？拿来吧你.png)
  5. 接下来调整默认级别为 Use fixed location![](../assets/images/Pasted%20image%2020260111022515.png)
  6. 在左侧菜单中选择Fixed Location![](../assets/images/Github学生包？拿来吧你-1.png)
  7. 地址改为学生证上的学校地址
  8. 前往 https://github.com/settings/education/benefits 进行申请
  9. 身份选择学生，然后选择学生证上的学校![](../assets/images/Github学生包？拿来吧你-2.png)
  10. 点击 Share Location
  11. 点击 Continue
  12. 在下一个页面选择学生证 Dated school ID ![](../assets/images/Github学生包？拿来吧你-3.png)
  13. 点击 start camera，这将会打开摄像头
  14. 将准备好的学生证图片展示在摄像头前面，要清晰
  15. 点击 Capture photo，这将会在3s后拍摄一张图片![](../assets/images/Github学生包？拿来吧你-4.png)
  16. 点击Continue，不出意外的话你会看到这个提示：你为什么不在校园？（Whay are you not on campus）![](../assets/images/Github学生包？拿来吧你-5.png)
  17. 选择Other或是All coursework is via distance learning 如果选择了Other理由写I am traveling
  18. 点击Smbmit application来提交申请
  19. 等待一段时间，刷新页面
  20. 如果看到Approved就是成功了，如果遇到denied拒绝的话就看详情，里面会有要求，照着做就好![Approved](../assets/images/Github学生包？拿来吧你-6.png)![denied](../assets/images/Github学生包？拿来吧你-7.png)
